...
function getadminseecustomerdetails() {
    ...
    $.ajax({
        type: 'GET',
        url: "/HotelManagement/Getemployeecustomerbookingdetails",
        data: {},
        dataType: 'json',
...
function getemployeecitybinding() {
    
    $.ajax({
        type: 'GET',
        url: "../HotelManagement/GetemployeeCityDetails",
        data: {},
        dataType: 'json',
        context: document.body,
        success: function (data) {
...
$("#city").change(function () {
    ...
    getcustomerhotelbinding();


});
function getcustomerhotelbinding() {
    ...
    $.ajax({
        type: 'GET',
        url: "../HotelManagement/GetemployeeHotelDetails",
        data: { cid: cid },
        dataType: 'json',
        context: document.body,
        success: function (data) {
